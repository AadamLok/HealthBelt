...
cur.execute("CREATE TABLE Sensor (dateAndtime VARCHAR(20), sensor txt)")

cur.execute("CREATE TABLE login (HardWareID VARCHAR(10), username VARCHAR(20), hash VARCHAR(50), email VARCHAR(20))")
cur.execute("CREATE TABLE Emergency (username VARCHAR(20), email txt)")
